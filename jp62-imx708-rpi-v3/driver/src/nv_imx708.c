/*
 * nv_imx708.c - imx708 sensor driver
 *
 * Copyright (c) 2021-2023, NVIDIA CORPORATION.  All rights reserved.
 * Copyright (c) 2023, RidgeRun <support@ridgerun.com>. All rights reserved.
 *
 * Adapted for JetPack 6.2 (L4T R36.4.x) out-of-tree build
 *
...
MODULE_AUTHOR("RidgeRun <support@ridgerun.com>");
MODULE_LICENSE("GPL v2");
MODULE_VERSION("2.0.6-jp62");
